  ...
  methods: {
    initList() {
      ...
      let list = [
        ...
        { url: 'https://rong.wetruetech.cn/zhkb/syqykbqlcfuzn.pdf', name: '企业开办全流程服务指南' }
      ]
      ...
      if (this.$utils.getLocalItem('curArea').district === '丹江口市') {
        list.push({ url: 'https://rong.wetruetech.cn/zhkb/djkqykbqlcfwzn.pdf', name: '丹江口市企业开办全流程服务指南' })
        list.push({ url: 'https://rong.wetruetech.cn/zhkb/ylt.pdf', name: '市场主体一链通模块操作指引手册' })
      }
      this.list = list
    },
    handleOpenHelpList() {
