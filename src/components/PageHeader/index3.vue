<template>
  <div class="page-header">
    ...
    >
      <div class="dialog">
        <div class="dialog-title" style="font-size: 18px;font-family: Source Han Sans CN;">请用微信扫描二维码授权登录</div>
        <div class="login-type-box">
          <!-- <div class="login-type" @click="$router.push('/idCardGuide')">
            <img style="width: 150px;height: 150px;margin-bottom:10px" src="../../assets/images/idCard.png" alt="" />
          ...
          <div class="login-type">
            ...
            <div class="dialog-tips">{{ $route.query.LoginTitle }}</div>
            <div>法定代表人才能查看和打印证照（如不是法定代表人，请使用法定代表人登录）</div>
          </div>
        </div>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    handleGo() {
      ...
      //   return
      // }
      if (this.$route.path !== '/selfDeclaration') {
        this.$router.replace('/selfDeclaration')
      }
    },
    login() {
      // 预留开发环境登录入口
