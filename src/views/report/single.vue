    ...
    <div class="companyMessageMain">
      ...
      <el-form ref="ruleForm" :model="form" :rules="rules" class="report_form">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item ref="企业通讯地址" label="企业通讯地址" prop="企业通讯地址">
              <el-input v-model.trim="form['企业通讯地址']" placeholder="请输入" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-form-item ref="邮政编码" label="邮政编码" prop="邮政编码">
          <el-input v-model.trim="form['邮政编码']" placeholder="请输入" clearable></el-input>
        </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-form-item ref="电子邮箱" label="电子邮箱" prop="电子邮箱">
          <el-input v-model.trim="form['电子邮箱']" placeholder="请输入" clearable></el-input>
        </el-form-item>
          </el-col>
        </el-row>
        <!-- <el-form-item ref="统一社会信用代码" label="统一社会信用代码" prop="统一社会信用代码">
          <el-input v-model.trim="form['统一社会信用代码']" placeholder="请输入" clearable></el-input>
        </el-form-item> -->
        <el-form-item ref="从业人数" label="从业人数（人员）" prop="从业人数">
          <el-row :gutter="10">
            <el-col :span="12">
              <el-input v-model="form['从业人数']" type="number" placeholder="请输入" clearable></el-input>
            </el-col>
            <el-col :span="12">
        ...
        <el-form-item ref="其中女性从业人数" label="其中女性从业人数" prop="其中女性从业人数">
          <el-row :gutter="10">
            <el-col :span="12">
              <el-input v-model="form['其中女性从业人数']" type="number" placeholder="请输入" clearable></el-input>
            </el-col>
            <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="企业控股状态" prop="企业控股状态">
              <el-select v-model="form['企业控股状态']" placeholder="请选择">
                <el-option label="私人控股" value="私人控股" />
              </el-select>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item ref="高校毕业生经营者人数" class="other-clo" label="经营者" prop="高校毕业生经营者人数">
              <el-input v-model="form['高校毕业生经营者人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('高校毕业生经营者人数')"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item ref="高校毕业生雇员人数" class="other-clo" label="雇员" prop="高校毕业生雇员人数">
              <el-input v-model="form['高校毕业生雇员人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('高校毕业生雇员人数')"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item ref="退役士兵经营者人数" class="other-clo" label="经营者" prop="退役士兵经营者人数">
              <el-input v-model="form['退役士兵经营者人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('退役士兵经营者人数')"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item ref="退役士兵雇员人数" class="other-clo" label="雇员" prop="退役士兵雇员人数">
              <el-input v-model="form['退役士兵雇员人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('退役士兵雇员人数')"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item ref="残疾人经营者人数" class="other-clo" label="经营者" prop="残疾人经营者人数">
              <el-input v-model="form['残疾人经营者人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('残疾人经营者人数')"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item ref="残疾人雇员人数" class="other-clo" label="雇员" prop="残疾人雇员人数">
              <el-input v-model="form['残疾人雇员人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('残疾人雇员人数')"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item ref="失业人员再就业经营者人数" class="other-clo" label="经营者" prop="失业人员再就业经营者人数">
              <el-input v-model="form['失业人员再就业经营者人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('失业人员再就业经营者人数')"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item ref="失业人员再就业雇员人数" class="other-clo" label="雇员" prop="失业人员再就业雇员人数">
              <el-input v-model="form['失业人员再就业雇员人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('失业人员再就业雇员人数')"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-form-item ref="中共党员（包括预备党员）人数" label="中共党员（包括预备党员）人数（人）" prop="中共党员（包括预备党员）人数">
          <el-input v-model="form['中共党员（包括预备党员）人数']" type="number" placeholder="请输入" clearable @blur="handleSetInt('中共党员（包括预备党员）人数')"></el-input>
        </el-form-item>
          </el-col>
          <el-col :span="12">
        <el-form-item label="党组织建制">
        ...
        <el-form-item label="法定代表人是否为党员">
          ...
          <el-col :span="12">
        <el-form-item label="法定代表人是否为党组织书记">
    ...
    saveDraftForm(type) {
      const params = {
        ...
        inData: {
          ...
          bizStateName: '草稿',
          bizCode: this.$utils.getBizCode().single,
          name: this.name,
          zgdw: '市场监督局',
          businessType: '1',
          draftData: this.form,
      ...
      this.$api.startJob(params).then(res => {
        if (res.state === 'successful') { // 跳转到下一页
          if (type === 'draft') {
            ...
            this.$router.push('/report/singleProperty?draftNumber=' + res.outData.draftNumber + '&pageOrigin=' + this.$route.query.pageOrigin)
          }
        } else {
