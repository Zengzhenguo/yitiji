  ...
  <div class="assetInfoContainer">
    ...
    <div class="assetInfo-main">
      ...
      <el-form ref="ruleForm" :model="form" :rules="rules" class="report_form" label-width="auto" label-position="left">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="资产总额（人民币万元）:" prop="资产总额">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['资产总额']" placeholder="请输入资产总额" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
                  <el-radio v-model="form['资产总额是否公示']" label="公示">公示</el-radio>
                  <el-radio v-model="form['资产总额是否公示']" label="不公示">不公示</el-radio>
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="所有者权益合计（人民币万元）:" prop="所有者权益合计">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['所有者权益合计']" placeholder="请输入所有者权益合计" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
                  <el-radio v-model="form['所有者权益合计是否公示']" label="公示">公示</el-radio>
                  <el-radio v-model="form['所有者权益合计是否公示']" label="不公示">不公示</el-radio>
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="负债总额（人民币万元）:" prop="负债总额">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['负债总额']" placeholder="请输入负债总额" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
                  <el-radio v-model="form['负债总额是否公示']" label="公示">公示</el-radio>
                  <el-radio v-model="form['负债总额是否公示']" label="不公示">不公示</el-radio>
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="营业总收入（人民币万元）:" prop="营业总收入">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['营业总收入']" placeholder="请输入营业总收入" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
                  <el-radio v-model="form['营业总收入是否公示']" label="公示">公示</el-radio>
                  <el-radio v-model="form['营业总收入是否公示']" label="不公示">不公示</el-radio>
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="其中主营业务收入（人民币万元）:" prop="其中主营业务收入">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['其中主营业务收入']" placeholder="请输入主营业务收入" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
                  <el-radio v-model="form['其中主营业务收入是否公示']" label="公示">公示</el-radio>
                  <el-radio v-model="form['其中主营业务收入是否公示']" label="不公示">不公示</el-radio>
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="利润总额（人民币万元）:" prop="利润总额">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['利润总额']" placeholder="请输入利润总额" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
                  <el-radio v-model="form['利润总额是否公示']" label="公示">公示</el-radio>
                  <el-radio v-model="form['利润总额是否公示']" label="不公示">不公示</el-radio>
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="净利润（人民币万元）:" prop="净利润">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['净利润']" placeholder="请输入净利润" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
                  <el-radio v-model="form['净利润是否公示']" label="公示">公示</el-radio>
                  <el-radio v-model="form['净利润是否公示']" label="不公示">不公示</el-radio>
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="纳税总额（人民币万元）:" prop="纳税总额">
              <el-row>
                <el-col :span="12">
                  <el-input v-model="form['纳税总额']" placeholder="请输入纳税总额" clearable />
                </el-col>
                <el-col :span="12" style="height: 45px;line-height: 45px;width: 134.5px;margin-right: -100px;">
        ...
        <el-button type="primary" style="display: block; margin: auto" @click="submitForm('ruleForm')">下一步</el-button>
      </el-form>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        '资产总额': [
          { required: true, message: '请输入资产总额', trigger: 'change' }
        ],
        '所有者权益合计': [
          { required: true, message: '请输入所有者权益合计', trigger: 'change' }
        ],
        '负债总额': [
          { required: true, message: '请输入负债总额', trigger: 'change' }
        ],
        '营业总收入': [
          { required: true, message: '请输入营业总收入', trigger: 'change' }
        ],
        '其中主营业务收入': [
          { required: true, message: '请输入其中主营业务收入', trigger: 'change' }
        ],
        '利润总额': [
      ...
      this.$api.startJob(params).then(res => {
        if (res.state === 'successful') { // 跳转到下一页
          if (type === 'draft') {
            ...
            this.$router.push('/report/optionalInfo?draftNumber=' + res.outData.draftNumber + '&pageOrigin=' + this.$route.query.pageOrigin)
          }
        } else {
