...
import { companyReportApply, draftDetail } from '@/api'
export default {
  components: {
    PageHeader,
    Breadcrumb
  ...
  methods: {
    ...
    applyAction(data) {
      companyReportApply(data).then(res => {
        if (+res.errCode === 1) {
