    ...
    <el-form ref="form" label-position="left" class="w-1000 form" :model="form" :rules="rules" label-width="94px">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item class="radio" label="请选择身份" label-width="110px" prop="role">
            <el-radio v-model="form.role" label="法定代表人" border @change="handleChangeType">法定代表人</el-radio>
            <el-radio v-model="form.role" label="经办人" border @change="handleChangeType">委托代理人</el-radio>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        ...
        <template v-if="form.role === '经办人'">
          <el-col :span="12">
            <el-form-item label="委托代理人姓名" label-width="190px" required>
              <el-input v-model="form.agentName" placeholder="请输入委托代理人姓名" :disabled="form.role === '经办人'" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import { getPrintPdfInfo ,getOrganization ,Personal_informationSearch} from '@/api/index'
...
export default {
  ...
  methods: {
    ...
    searchData() {
      ...
      //   idName: this.form.legalPerson,
      //   city: this.curArea.district
      //   // companyName: '十堰隆浩彩钢有限公司',
      //   // creditCode: '91420300MA49Q31T6U',
      //   // idName: '田青',
      //   // city: '十堰经济技术开发区'
      // }
      // console.log(inData)
      // this.$loading({ text: '查询时间较长，请耐心等待' })
      // getPrintPdfInfo(inData).then(res => {
      //   this.dialogSign = false
      //   this.$loading().close()
      //   // 'bcb7db636d204b6e8e30b7fdef43fa9d.pdf'
      //   if (res.state === 'successful') {
      //     this.hanldePrintImg(res.outData.archive_url)
      //   } else {
