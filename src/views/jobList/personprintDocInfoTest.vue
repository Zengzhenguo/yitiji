      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="统一社会信用代码" prop="creditCode" label-width="184px">
            <el-input v-model.trim="form.creditCode" placeholder="企业的统一社会信用代码" maxlength="20" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- <el-row :gutter="20">
...
import { getPrintPdfInfo ,getOrganization ,Personal_informationSearch,Personal_directorySearch} from '@/api/index'
