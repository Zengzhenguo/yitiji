<!--
 * @Author: your name
 * @Date: 2021-12-08 14:33:21
 * @LastEditTime: 2021-12-08 14:44:51
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \ec-gov-biz-hubei-terminal\src\views\form\companyLogoutLicense.vue
-->
<template>
  <div class="home-page">
    <page-header />
    ...
    <main>
      ...
      <div class="center">
        <div class="business-content">
          <div class="content-item" @click="next()">
            <div class="content-bg">
              <img src="../../assets/marketEntity/bg13.png" alt="" />
            </div>
