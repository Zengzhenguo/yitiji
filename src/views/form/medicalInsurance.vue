    ...
    <div class="address-form">
      ...
      <div class="box">
        ...
        <el-form ref="form" label-position="left" class="form" :model="form" :rules="rules" label-width="94px">
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item class="radio" label="是否预约医保业务" prop="isReservationSocialSecurityBusiness" label-width="274px">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="经济类型" prop="economicType" label-width="140px">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="行业风险类别" prop="industryRiskCategory" label-width="140px">
                <el-select v-model="form.industryRiskCategory" placeholder="请选择">
                  <el-option
                    v-for="item in industryRiskCategoryList"
                    :key="item"
                    :label="item"
                    :value="item"
                  />
            ...
            <el-col :span="12">
              <el-form-item label="隶属关系" prop="affiliation" label-width="140px">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="登记类型" prop="registrationType" label-width="140px">
            ...
            <el-col :span="12">
              <el-form-item label="单位类型" prop="unitType" label-width="140px">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="单位医保联络员姓名" prop="socialSecurityName" label-width="170px">
                <el-input v-model="form.socialSecurityName" style="width: 221px;" placeholder="请填写" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="单位医保联络员身份证号码" prop="socialSecurityIdcNum" class="socialSecurity" label-width="140px">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="单位医保联络员联系电话" prop="socialSecurityPhone" label-width="200px">
                <el-input v-model="form.socialSecurityPhone" maxlength="11" style="width: 221px;" placeholder="请填写" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row v-if="showJysqb" :gutter="20">
            <el-col :span="12">
              <el-form-item class="house-pic" label="在职职工减员申报" label-width="180px" prop="jysqbUrl">
                <div style="display: flex;">
                  <upload-code placement="bottom-start" alias="jysqbUrl" @update="updateFileList" />
                  <el-button type="text" @click="openDialog = true">查看在职职工减员申报表模版.xls</el-button>
                </div>
              </el-form-item>
              <el-form-item v-if="form.jysqbUrl" label="" label-width="180px">
                <div style="font-size:16px; color:#666;">{{ form.jysqbUrl }}</div>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="4">
              <el-form-item label="医保网点" prop="socialSecurityOutlets" label-width="120px" />
            </el-col>
            <el-col :span="20">
              <div class="seal-adress-box">
                <div class="seal-adress-list">
                  <el-radio-group v-model="form.socialSecurityOutlets">
                    <el-radio v-for="(item,index) in socialList" :key="index" :label="item.outletsName" class="seal-adress-item">
          ...
          <el-form-item class="btn-group text-center" label-width="0">
            ...
            <el-button v-if="businessShow.sdqwchecked||businessShow.dlchecked||businessShow.waterchecked||businessShow.rqchecked" type="primary" @click="handleNext">下一步</el-button>
      ...
      return {
        ...
        rules: {
          isReservationSocialSecurityBusiness: [
            { required: true, message: '请选择是否预约医保业务', trigger: 'change' }
          ],
          economicType: [
        ...
        socialList: [], // 医保网点
        form: {
          isReservationSocialSecurityBusiness: true, // 是否预约医保
          ...
          unitType: '企业', // 单位类型
          socialSecurityName: '', // 单位医保联络员姓名
          socialSecurityIdcNum: '', // 单位医保联络员身份证号码
          socialSecurityPhone: '', // 单位医保联络员联系电话
          addressArea: [], // 行政区划
      ...
      this.getAreaInfo().then(async () => {
        ...
        if (this.$utils.getItem('draftNumber')) {
          this.$store.dispatch('draft/getDraftDetail', this.$utils.getItem('draftNumber')).then(async res => {
            if (res.medicalInsuranceRegistration) {
              const medicalInsuranceForm = res.socialSecurityRegistration
              this.form = medicalInsuranceForm
            }
          })
        }
      })
    ...
    methods: {
      ...
      handleSaveDraft(showTips = false) {
        return new Promise((resolve, reject) => {
          const data = {
            ...this.draftInfo, // 原有数据
            medicalInsuranceRegistration: this.form, // 现在数据覆盖原有数据
            businessType: '2',
            showTips // 是否显示提示
          }
      ...
      handleNext() {
        ...
        this.$refs['form'].validate(async valid => {
          if (valid) {
            ...
            this.$utils.setItem('medicalInsuranceRegistration', this.form)
