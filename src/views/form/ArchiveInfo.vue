        ...
        <div class="pdf">
          <div v-if="this.pdf_isshow" class="pdfDiv">
            <div class="ArchiveInfomationStyle">
              ...
              <div class="rowInfomationStyle">
                <el-row>
                  <el-col :span="6"><div class="grid-content bg-purple flexCenter">经营者</div></el-col>
                  <el-col :span="6"><div class="grid-content bg-purple-light flexCenter"><div class="textBorder">{{nowArchiveObject.name?nowArchiveObject.name:'暂无数据'}}</div></div></el-col>
                  <el-col :span="6"><div class="grid-content bg-purple flexCenter">住所</div></el-col>
                  <el-col :span="6"><div class="grid-content bg-purple-light flexCenter"><div class="textBorder">{{nowArchiveObject.dom?nowArchiveObject.dom:'暂无数据'}}</div></div></el-col>
                </el-row>
              </div>
              <div class="rowInfomationStyle">
                <el-row>
                  <el-col :span="6"><div class="grid-content bg-purple">邮政编码</div></el-col>
                  <el-col :span="6"><div class="grid-content bg-purple-light"><div class="textBorder">
                    <!-- {{nowArchiveObject.regorg}} -->
                    暂无数据
                  </div></div></el-col>
                  <el-col :span="6"><div class="grid-content bg-purple">登记机关</div></el-col>
                  <el-col :span="6"><div class="grid-content bg-purple-light"><div class="textBorder">{{nowArchiveObject.regorg_cn?nowArchiveObject.regorg_cn:'暂无数据'}}</div></div></el-col>
                </el-row>
              </div>
              <div class="rowInfomationStyle">
                <el-row>
              ...
              <div class="rowInfomationStyle">
                <el-row>
                  ...
                  <el-col :span="6"><div class="grid-content bg-purple-light"><div class="textBorder">{{nowArchiveObject.empnum?nowArchiveObject.empnum:'暂无数据'}}</div></div></el-col>
                </el-row>
              </div>
            </div>
          </div>
          <div v-else>
           <strong>请点击左侧[目录]查看公司基础信息</strong> 
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      pdfURLPre :'https://scjg.hubei.gov.cn/zhkb/open-platform/',
      pdfURL:'',
      nowArchiveObject:{}
    }
  },
...
.flexCenter {
    ...
    min-height: 150px; /* change this value to adjust the minimum height */
}
.textBorder{
  width: 100%;
  height: 100%;
