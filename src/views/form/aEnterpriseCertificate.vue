<!--
 * @Author: your name
 * @Date: 2021-11-19 09:16:40
 * @LastEditTime: 2022-09-02 10:40:56
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: /ec-gov-biz-hubei-pc/src/views/form/aEnterpriseCertificate.vue
-->
<template>
  <div class="home-page">
    <page-header />
      ...
      <div class="center">
        <div class="business-content">
          ...
          >
            ...
            <div class="content-title">{{ item.titile }}</div>
            <div class="content-text">{{ item.describe }}</div>
          </div>
        </div>
      </div>
      <div class="bottom">
