  ...
  <div class="address-form">
    ...
    <div class="box">
      ...
      <el-form ref="form" label-position="left" class="form" :model="form" :rules="rules" label-width="94px">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="单位社保联络员姓名" prop="socialSecurityName" label-width="170px">
              <el-input v-model="form.socialSecurityName" style="width: 221px;" placeholder="请填写" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="单位社保联络员身份证号码" prop="socialSecurityIdcNum" class="socialSecurity" label-width="140px">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="单位社保联络员联系电话" prop="socialSecurityPhone" label-width="200px">
        ...
        <el-row :gutter="20">
          <el-col :span="4">
            <el-form-item label="社保网点" prop="socialSecurityOutlets" label-width="120px" />
          </el-col>
          <el-col :span="20">
        ...
        <el-form-item class="btn-group text-center" label-width="0">
          ...
          <el-button v-if="businessShow.swchecked||businessShow.yhchecked || businessShow.gjjchecked || businessShow.ylchecked || businessShow.sdqwchecked||businessShow.dlchecked" type="primary" @click="handleNext">下一步</el-button>
