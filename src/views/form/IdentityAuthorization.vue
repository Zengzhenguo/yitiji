<!--
 * @Author: your name
 * @Date: 2021-11-17 15:56:41
 * @LastEditTime: 2021-11-18 11:40:09
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \ec-gov-biz-hubei-terminal\src\views\form\IdentityAuthorization.vue
-->
<template>
  <div class="list-page">
    <breadcrumb />
    ...
    <div class="tips">
      ...
      <span>法定代表人、主要经营者或委托代理人才能授权刻章、开户</span>
    </div>
...
export default {
  ...
  methods: {
    ...
    //     this.$store.commit('draft/SET_DRAFT_INFO', null)
      ...
      this.$utils.setItem('authorization', this.form)
      if (this.$route.query.type === 'seal') {
        this.$router.push({ path: '/form/subscribeSeal' })
      }
      if (this.$route.query.type === 'bank') {
